...
public class ModPlacedFeatures {
    public static final RegistryKey<PlacedFeature> LUMEN_BLUE_KEY = registerKey("lumen_blue");

    public static void boostrap(Registerable<PlacedFeature> context) {
        RegistryEntryLookup<ConfiguredFeature<?, ?>> registryLookup = context.getRegistryLookup(RegistryKeys.CONFIGURED_FEATURE);
        register(context, LUMEN_BLUE_KEY, registryLookup.getOrThrow(ModConfiguredFeatures.LUMEN_BLUE_KEY),
                VegetationPlacedFeatures.treeModifiersWithWouldSurvive(
                        PlacedFeatures.createCountExtraModifier(1, 0.2f, 3),
                        ModBlocks.LUMEN_SAPLING_BLUE));

    }

    private static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Voidbreak.MOD_ID));
    }
